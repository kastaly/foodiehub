        ...
        <div class="hidden md:flex md:flex-col md:items-end md:leading-tight">
          ...
          <span class="text-sm text-gray-600">Lecturer</span>
            ...
            <div class='ml-3'>
             ...
             <img src="{{ asset(Auth::user()->profile_picture) }}" class="rounded-full w-12 h-12 mr-3 object-cover border-2 border-gray-500 ">
               @else
            <img src="{{ asset('storage/' . Auth::user()->profile_picture) }}" class="rounded-full w-12 h-12 mr-3 object-cover border-2 border-gray-500 ">
           @endif
           </div>               
