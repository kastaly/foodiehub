    ...
    <div class="container py-8 mx-auto">
        <div class="max-w-4xl mx-auto">
            ...
            <form method="post" action="{{ route('recipes.update', $recipe->id) }}" enctype="multipart/form-data" 
                ...
                @csrf
                @method('PUT')
                <h3 class="text-2xl font-semibold text-gray-800 dark:text-gray-200 mb-4">Edit Recipe</h3>
                <!-- Title -->
                <div class="mb-6">
                    <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Title</label>
                    <input type="text" name="title" id="title" placeholder="Enter the title of your recipe" required
                        class="form-input w-full mt-1 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-700 dark:text-gray-200 dark:focus:ring-orange-500 dark:border-gray-600" value="{{ $recipe->title }}">
                </div>
                <!-- Category -->
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="steps" id="steps" rows="4" placeholder="Enter the steps to prepare the recipe" required
                        class="form-textarea w-full mt-1 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-700 dark:text-gray-200 dark:focus:ring-orange-500 dark:border-gray-600">{{ $recipe->steps }}</textarea>
                </div>
                <!-- Ingredients -->
                <div class="mb-6">
                    ...
                    <textarea name="ingredients" id="ingredients" rows="4" placeholder="Enter the ingredients required" required
                        class="form-textarea w-full mt-1 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-700 dark:text-gray-200 dark:focus:ring-orange-500 dark:border-gray-600">{{ $recipe->ingredients }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div>
                        ...
                        <input type="number" name="total_time" id="total_time" placeholder="Enter total preparation time" required
                            class="form-input w-full mt-1 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-700 dark:text-gray-200 dark:focus:ring-orange-500 dark:border-gray-600" value="{{ $recipe->total_time }}">
                    </div>
                    <div>
                        ...
                        <input type="number" name="servings" id="servings" placeholder="Enter the number of servings" required
                            class="form-input w-full mt-1 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:bg-gray-700 dark:text-gray-200 dark:focus:ring-orange-500 dark:border-gray-600" value="{{ $recipe->servings }}">
                    </div>
                </div>
                <!-- Image -->
                <div class="mb-6">
                ...
                <div class="flex justify-center">
                    <button type="submit"
                        class="px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-400">Update Recipe</button>
                </div>
            </form>
        </div>
    </div>
