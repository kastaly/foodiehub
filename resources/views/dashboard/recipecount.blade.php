<section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
    ...
    <div class="flex items-center p-8 bg-white shadow rounded-lg">
        ...
        <div>
            <span class="block text-2xl font-bold">{{ count($recipes) }}</span>
    ...
    <div class="flex items-center p-8 bg-white shadow rounded-lg">
        ...
        <div>
            <span class="block text-2xl font-bold">{{ $usedCategories->count() }}</span>
    ...
    <div class="flex items-center p-8 bg-white shadow rounded-lg">
        ...
        <div class="">
            <div class="items-center">  
                <span class="inline-block text-2xl font-bold">{{ $views->sum('views') }}</span>
                <span class="block text-gray-500">Total Views of my Recipes</span>
